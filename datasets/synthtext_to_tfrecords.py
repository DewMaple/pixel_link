...
def cvt_to_tfrecords(output_path, data_path, gt_path, records_per_file=50000):
    ...
    for image_idx in image_idxes:
        ...
        print
        "converting image %d/%d" % (record_count, fetcher.num_images)
...
if __name__ == "__main__":
    ...
    cvt_to_tfrecords(output_path=util.io.join_path(output_dir, 'SynthText_%d.tfrecord'), data_path=root_path,
                     gt_path=mat_path)
